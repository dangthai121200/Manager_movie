...
public class Movie  implements java.io.Serializable {
    ...
    public String toString() {
        return "Movie{" + "idMovie=" + idMovie + ", filmtype=" + filmtype + ", nameMovie=" + nameMovie + ", country=" + country + ", director=" + director + ", timeMovie=" + timeMovie + ", statusMovie=" + statusMovie + ", urlimage=" + urlimage + ", content=" + content + ", yearOfManufacture=" + yearOfManufacture + ", dateAdd=" + dateAdd + ", movieAdmins=" + movieAdmins + ", categoryMoives=" + categoryMoives + '}';
    }
