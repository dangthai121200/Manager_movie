                ...
                <div class="mt-2">
                  ...
                  >
                    <input
                      ...
                      value="Phim lưu"
                    />
                    <span class="ml-2">Phiêu lưu</span>
                  </label>
                  <label
                    class="inline-flex items-center ml-6 text-gray-600 dark:text-gray-400"
                  >
                    <input
                      ...
                      value="Hành động"
                    />
                    <span class="ml-2">hành động</span>
                  </label>
                    <label
                    class="inline-flex items-center ml-6 text-gray-600 dark:text-gray-400"
                  >
                    <input
                      ...
                      value="Trinh thám"
                    />
                    <span class="ml-2">Trinh thám</span>
                  </label>
